...
impl Theme {
    ...
    pub const fn one_dark_warmer() -> Self {
        Self::from_colors(
            ThemeNames::OneDarkWarmer,
            [
                Color::Rgb(222, 93, 104),
                Color::Rgb(209, 125, 235),
                Color::Rgb(187, 112, 210),
                Color::Rgb(159, 95, 179),
                Color::Rgb(74, 140, 195),
                Color::Rgb(87, 165, 229),
                Color::Rgb(81, 168, 179),
                Color::Rgb(69, 143, 152),
                Color::Rgb(122, 154, 98),
                Color::Rgb(143, 181, 115),
                Color::Rgb(160, 203, 129),
                Color::Rgb(245, 204, 127),
                Color::Rgb(219, 182, 113),
                Color::Rgb(196, 144, 96),
                Color::Rgb(249, 104, 116),
    ...
    pub const fn catppuccin_macchiato() -> Self {
        Self::from_colors(
            ThemeNames::CatppuccinMacchiato,
            [
    ...
    pub const fn tokyo_night_moon() -> Self {
        Self::from_colors(
            ThemeNames::TokyoNightMoon,
            [
                Color::Rgb(255, 117, 127),
                Color::Rgb(255, 0, 124),
                Color::Rgb(192, 153, 255),
                Color::Rgb(252, 167, 234),
                Color::Rgb(130, 170, 255),
                Color::Rgb(130, 170, 255),
                Color::Rgb(134, 225, 252),
                Color::Rgb(79, 214, 190),
                Color::Rgb(195, 232, 141),
                Color::Rgb(195, 232, 141),
                Color::Rgb(213, 222, 134),
                Color::Rgb(255, 199, 119),
                Color::Rgb(255, 150, 108),
                Color::Rgb(255, 150, 108),
                Color::Rgb(255, 124, 123),
                Color::Rgb(165, 111, 89),
                Color::Rgb(77, 46, 49),
                Color::Rgb(62, 71, 47),
            ],
            [
                ...
                Color::Rgb(68, 74, 115),
                Color::Rgb(200, 211, 245),
                Color::Rgb(210, 221, 255),
            ],
        )
    }

    pub const fn dracula_soft() -> Self {
        Self::from_colors(
            ThemeNames::DraculaSoft,
            [
                Color::Rgb(221, 110, 107),
                Color::Rgb(228, 140, 193),
                Color::Rgb(186, 160, 232),
                Color::Rgb(173, 161, 233),
                Color::Rgb(165, 197, 237),
                Color::Rgb(167, 223, 239),
                Color::Rgb(167, 223, 239),
                Color::Rgb(160, 237, 237),
                Color::Rgb(135, 229, 142),
                Color::Rgb(151, 237, 162),
                Color::Rgb(175, 237, 162),
                Color::Rgb(232, 237, 162),
                Color::Rgb(245, 224, 152),
                Color::Rgb(253, 195, 142),
                Color::Rgb(225, 131, 127),
                Color::Rgb(172, 137, 104),
                Color::Rgb(81, 49, 49),
                Color::Rgb(50, 75, 52),
            ],
            [
    ...
    pub const fn nightfox() -> Self {
        Self::from_colors(
            ThemeNames::Nightfox,
            [
                Color::Rgb(201, 79, 109),
                Color::Rgb(214, 122, 210),
                Color::Rgb(157, 121, 214),
                Color::Rgb(133, 103, 182),
                Color::Rgb(96, 133, 182),
                Color::Rgb(113, 156, 214),
                Color::Rgb(99, 205, 207),
                Color::Rgb(84, 174, 176),
                Color::Rgb(129, 178, 154),
                Color::Rgb(142, 186, 164),
                Color::Rgb(165, 188, 150),
                Color::Rgb(219, 192, 116),
                Color::Rgb(244, 162, 97),
                Color::Rgb(244, 162, 97),
                Color::Rgb(209, 105, 131),
                Color::Rgb(150, 116, 88),
                Color::Rgb(68, 41, 47),
                Color::Rgb(41, 62, 52),
            ],
    ...
    pub const fn duskfox() -> Self {
        Self::from_colors(
            ThemeNames::Duskfox,
            [
                Color::Rgb(235, 111, 146),
                Color::Rgb(235, 152, 195),
                Color::Rgb(196, 167, 231),
                Color::Rgb(165, 128, 210),
                Color::Rgb(74, 134, 156),
                Color::Rgb(86, 159, 186),
                Color::Rgb(156, 207, 216),
                Color::Rgb(123, 184, 193),
                Color::Rgb(163, 190, 140),
                Color::Rgb(177, 209, 150),
                Color::Rgb(198, 204, 141),
                Color::Rgb(246, 193, 119),
                Color::Rgb(234, 154, 151),
                Color::Rgb(234, 154, 151),
                Color::Rgb(240, 131, 162),
                Color::Rgb(159, 113, 111),
                Color::Rgb(77, 46, 55),
                Color::Rgb(58, 71, 47),
            ],
            [
                ...
                Color::Rgb(224, 222, 244),
                Color::Rgb(205, 203, 224),
                Color::Rgb(129, 124, 156),
                Color::Rgb(110, 106, 134),
                Color::Rgb(99, 87, 125),
                Color::Rgb(75, 70, 115),
                Color::Rgb(67, 60, 89),
    ...
    pub const fn nordfox() -> Self {
        Self::from_colors(
            ThemeNames::Nordfox,
            [
                Color::Rgb(191, 97, 106),
                Color::Rgb(191, 136, 188),
                Color::Rgb(180, 142, 173),
                Color::Rgb(157, 116, 149),
                Color::Rgb(102, 138, 171),
                Color::Rgb(129, 161, 193),
                Color::Rgb(136, 192, 208),
                Color::Rgb(105, 167, 186),
                Color::Rgb(163, 190, 140),
                Color::Rgb(177, 209, 150),
                Color::Rgb(194, 207, 147),
                Color::Rgb(235, 203, 139),
                Color::Rgb(201, 130, 107),
                Color::Rgb(201, 130, 107),
                Color::Rgb(208, 111, 121),
                Color::Rgb(123, 100, 93),
                Color::Rgb(91, 55, 58),
                Color::Rgb(69, 84, 56),
            ],
            [
    ...
    pub const fn terafox() -> Self {
        Self::from_colors(
            ThemeNames::Terafox,
            [
                Color::Rgb(232, 92, 81),
                Color::Rgb(203, 121, 133),
                Color::Rgb(173, 92, 124),
                Color::Rgb(147, 78, 105),
                Color::Rgb(77, 125, 144),
                Color::Rgb(90, 147, 170),
                Color::Rgb(161, 205, 216),
                Color::Rgb(137, 174, 184),
                Color::Rgb(122, 164, 161),
                Color::Rgb(142, 178, 175),
                Color::Rgb(175, 174, 161),
                Color::Rgb(253, 164, 127),
                Color::Rgb(255, 131, 73),
                Color::Rgb(255, 131, 73),
                Color::Rgb(235, 116, 107),
                Color::Rgb(149, 102, 80),
                Color::Rgb(60, 38, 36),
                Color::Rgb(37, 54, 53),
            ],
            [
                ...
                Color::Rgb(203, 217, 216),
                Color::Rgb(109, 127, 139),
                Color::Rgb(88, 123, 123),
                Color::Rgb(66, 94, 94),
                Color::Rgb(45, 79, 86),
                Color::Rgb(37, 65, 71),
                Color::Rgb(29, 51, 55),
    ...
    pub const fn dayfox() -> Self {
        Self::from_colors(
            ThemeNames::Dayfox,
            [
                Color::Rgb(165, 34, 47),
                Color::Rgb(164, 64, 181),
                Color::Rgb(110, 51, 206),
                Color::Rgb(94, 43, 175),
                Color::Rgb(34, 61, 144),
                Color::Rgb(40, 72, 169),
                Color::Rgb(40, 121, 128),
                Color::Rgb(34, 103, 109),
                Color::Rgb(57, 104, 71),
                Color::Rgb(87, 127, 99),
                Color::Rgb(112, 114, 70),
                Color::Rgb(172, 84, 2),
                Color::Rgb(149, 95, 97),
                Color::Rgb(149, 95, 97),
                Color::Rgb(179, 67, 78),
                Color::Rgb(91, 80, 80),
                Color::Rgb(245, 219, 222),
                Color::Rgb(222, 237, 226),
            ],
            [
                Color::Rgb(48, 43, 93),
                Color::Rgb(100, 63, 97),
                Color::Rgb(130, 77, 91),
                Color::Rgb(131, 122, 114),
                Color::Rgb(170, 176, 173),
                Color::Rgb(164, 193, 194),
                Color::Rgb(211, 199, 187),
                Color::Rgb(219, 209, 221),
                Color::Rgb(231, 210, 190),
                Color::Rgb(228, 220, 212),
    ...
    pub const fn dawnfox() -> Self {
        Self::from_colors(
            ThemeNames::Dawnfox,
            [
                Color::Rgb(180, 99, 122),
                Color::Rgb(214, 133, 175),
                Color::Rgb(144, 122, 169),
                Color::Rgb(129, 107, 154),
                Color::Rgb(41, 94, 115),
                Color::Rgb(40, 105, 131),
                Color::Rgb(86, 148, 159),
                Color::Rgb(80, 132, 140),
                Color::Rgb(97, 135, 116),
                Color::Rgb(98, 159, 129),
                Color::Rgb(139, 158, 106),
                Color::Rgb(234, 157, 52),
                Color::Rgb(215, 130, 126),
                Color::Rgb(215, 130, 126),
                Color::Rgb(194, 109, 133),
                Color::Rgb(138, 102, 100),
                Color::Rgb(241, 226, 230),
    ...
    pub const fn oxocarbon_dark() -> Self {
        Self::from_colors(
            ThemeNames::OxocarbonDark,
            [
                Color::Rgb(238, 83, 150),
                Color::Rgb(255, 126, 182),
                Color::Rgb(190, 149, 255),
    ...
    pub const fn oxocarbon_light() -> Self {
        Self::from_colors(
            ThemeNames::OxocarbonLight,
            [
                Color::Rgb(238, 83, 150),
                Color::Rgb(255, 126, 182),
                Color::Rgb(190, 149, 255),
                Color::Rgb(166, 117, 246),
                ...
                Color::Rgb(116, 86, 62),
                Color::Rgb(250, 239, 244),
                Color::Rgb(236, 248, 240),
            ],
            [
                Color::Rgb(22, 22, 22),
                Color::Rgb(55, 71, 79),
...
impl ThemeNames {
    pub const fn label(self) -> &'static str {
        match self {
            ...
            Self::OneDarkWarmer => "one dark warmer",
...
pub const THEME_PRESETS: &[ThemePreset] = &[
    ...
    ThemePreset { label: "one dark warmer", theme: Theme::one_dark_warmer() },
    ...
    ThemePreset { label: "catppuccin macchiato", theme: Theme::catppuccin_macchiato() },
    ThemePreset { label: "catppuccin frappe", theme: Theme::catppuccin_frappe() },
    ThemePreset { label: "tokyo night moon", theme: Theme::tokyo_night_moon() },
    ThemePreset { label: "dracula soft", theme: Theme::dracula_soft() },
    ThemePreset { label: "nightfox", theme: Theme::nightfox() },
    ThemePreset { label: "duskfox", theme: Theme::duskfox() },
    ThemePreset { label: "nordfox", theme: Theme::nordfox() },
    ThemePreset { label: "terafox", theme: Theme::terafox() },
    ThemePreset { label: "carbonfox", theme: Theme::carbonfox() },
    ThemePreset { label: "dayfox", theme: Theme::dayfox() },
    ThemePreset { label: "dawnfox", theme: Theme::dawnfox() },
    ThemePreset { label: "oxocarbon dark", theme: Theme::oxocarbon_dark() },
    ThemePreset { label: "oxocarbon light", theme: Theme::oxocarbon_light() },
];
