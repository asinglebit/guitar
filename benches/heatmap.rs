...
fn heatmap_fixture(rounds: usize) -> HeatmapFixture {
    ...
    HeatmapFixture { _graph_fixture: Some(fixture), _temp_fixture: None, repo, oids }
}
...
fn dated_heatmap_fixture(recent_commits: usize, old_commits: usize) -> HeatmapFixture {
    ...
    HeatmapFixture { _graph_fixture: None, _temp_fixture: Some(fixture), repo: gix_repo, oids }
}
