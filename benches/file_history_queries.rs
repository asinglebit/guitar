...
fn changed_file_status_sparse_small(bencher: divan::Bencher) {
    ...
    bencher.counter(divan::counter::ItemsCount::new(17usize)).bench_local(|| divan::black_box(changed_file_status(&fixture)));
}
...
fn changed_file_status_frequent_medium(bencher: divan::Bencher) {
    ...
    bencher.counter(divan::counter::ItemsCount::new(49usize)).bench_local(|| divan::black_box(changed_file_status(&fixture)));
}
...
fn changed_file_status_rename_stress(bencher: divan::Bencher) {
    ...
    bencher.counter(divan::counter::ItemsCount::new(98usize)).bench_local(|| divan::black_box(changed_file_status(&fixture)));
}
